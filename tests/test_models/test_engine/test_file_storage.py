#!/usr/bin/python3
"""To define unnittests for models/engine/file_storage.py."""
import os
import json
import pep8
import unittest
...
class TestFileStorage(unittest.TestCase):
    """The unittests for testing the FileStorage class."""

    @classmethod
    def setUpClass(cls):
        """The fileStorage testing setup.
    ...
    def tearDownClass(cls):
        """The fileStorage testing teardown.
    ...
    def test_pep8_FileStorage(self):
        """To test pep8 styling."""
        style = pep8.StyleGuide(quiet=True)
        p = style.check_files(['models/engine/file_storage.py'])
        self.assertEqual(p.total_errors, 0, "fix pep8")

    def test_docstrings(self):
        """To check for docstrings."""
